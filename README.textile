...
* The basic creational non-pattern used as a basis for the rest of the creational patterns
* Factory Method
* Strategy

Please feel welcome to comment, point out my errors, and of course use for your own study and benefit. For a fast reference on how to implement design patterns in Ruby, i also recommend "shvets/design_patterns_in_ruby":http://github.com/shvets/design_patterns_in_ruby/.