...
This pattern feels rather like the Strategy pattern to me, only for creating things. It has a distinct feel of taking multiple things and sticking them together, so i can understand why the book says it is often used to create a Composite.
